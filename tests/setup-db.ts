...
async function main() {
  ...
  // Create btree_gist extension (required for exclusion constraints)
  await preClient.query(`CREATE EXTENSION IF NOT EXISTS btree_gist`)
  console.log("  btree_gist extension created.")
