...
import { GroupHistoryDetailDialog } from "@/components/employees/group-history-detail-dialog"
...
export function EmployeeGroupHistorySection({ groupHistory, groups, isAuthenticated }: Props) {
  const [open, setOpen] = useState(false)
  const [selectedEntry, setSelectedEntry] = useState<EmployeeGroupHistoryEntry | null>(null)
